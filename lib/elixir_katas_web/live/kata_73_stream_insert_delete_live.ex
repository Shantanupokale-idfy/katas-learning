defmodule ElixirKatasWeb.Kata73StreamInsertDeleteLive do
  ...
  def mount(_params, _session, socket) do
    ...
    notes_content = File.read!("notes/kata_73_stream_insert_delete_notes.md")
  ...
  def render(assigns) do
    ...
    <.kata_viewer 
      ...
      title="Kata 73: Stream Insert/Delete" 
      ...
      <div class="p-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border">
          <div class="flex gap-2 mb-4">
            <button phx-click="add_top" class="px-4 py-2 bg-green-600 text-white rounded">
              Add to Top
            </button>
            <button phx-click="add_bottom" class="px-4 py-2 bg-blue-600 text-white rounded">
              Add to Bottom
            </button>
          </div>
          ...
          <div id="items" phx-update="stream" class="space-y-2">
            <%= for {dom_id, item} <- @streams.items do %>
              <div id={dom_id} class="flex items-center justify-between p-3 bg-gray-50 rounded">
                ...
                <button phx-click="delete" phx-value-id={item.id} class="px-3 py-1 bg-red-500 text-white rounded text-sm">
                  Delete
                </button>
              </div>
            <% end %>
